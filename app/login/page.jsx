...
export default function LoginPage() {
  ...
  return (
    <div className="-mx-4 -my-8 min-h-[92vh] bg-[#0B1120] text-white flex flex-col items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto space-y-8 text-center">
        ...
        {/* UNIFIED BRANDING: One Official Washington School Inc. Logo & Primary Gradient Headline */}
        <div className="space-y-4">
          
          {/* Single Official Logo Badge */}
          ...
          <p className="text-xs text-slate-400 max-w-sm mx-auto leading-relaxed">
            Official HR authorization portal for faculty absences, substitute coverage claiming, and administrative approvals.
          </p>
        </div>

        {/* UNIFIED LOGIN CARD */}
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 text-left border border-slate-100/90 text-slate-900 animate-in fade-in zoom-in-95 duration-300">
        ...
        {/* Subtle Footer Feature Badges */}
        <div className="pt-2 flex flex-wrap items-center justify-center gap-2 text-[11px] text-slate-400 font-medium">
          <span className="px-2.5 py-1 rounded-full bg-slate-800/60 border border-slate-700/60 flex items-center gap-1 text-slate-300">
