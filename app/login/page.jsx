...
export default function LoginPage() {
  ...
  return (
    <div className="w-full flex-1 bg-[#0B1120] text-white flex items-center justify-center p-6 sm:p-10 lg:p-16 relative overflow-hidden">
      
      {/* Background Glow Orbs */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-violet-600/10 rounded-full blur-3xl pointer-events-none"></div>

      {/* Responsive Split-Screen Grid: 1 col on mobile, 2 cols on lg screens */}
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10 py-6">
        ...
        <div className="space-y-6 text-center lg:text-left flex flex-col justify-center items-center lg:items-start">
          ...
          <div className="inline-flex items-center space-x-3 px-4 py-2 rounded-2xl bg-slate-800/80 border border-slate-700/80 shadow-xl backdrop-blur-md">
            ...
            <div className="text-left">
              <span className="block text-xs font-bold text-slate-200 tracking-wide">
          ...
          <p className="text-sm text-slate-300 max-w-md leading-relaxed">
            Centralized portal for managing faculty absence requests, automated class coverage schedules, substitute staffing, and administrative approval workflows.
          </p>
        </div>

        {/* RIGHT COLUMN: Centered Login Card */}
        <div className="flex justify-center w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-slate-100/90 text-slate-900 animate-in fade-in zoom-in-95 duration-300">
            
            {/* Tab Switcher */}
            <div className="p-1 rounded-2xl bg-slate-100 border border-slate-200/80 mb-6 flex">
              <button
                type="button"
                onClick={() => {
                  setActiveTab('login');
            ...
            {/* Error Alert Box */}
            {errorMsg && (
              <div className="p-3.5 mb-5 rounded-xl bg-rose-50 border border-rose-200 flex items-start space-x-2.5 text-rose-800 text-xs animate-in fade-in">
            ...
            {/* Success Alert Box */}
            {successMsg && (
              <div className="p-3.5 mb-5 rounded-xl bg-emerald-50 border border-emerald-200 flex items-start space-x-2.5 text-emerald-800 text-xs animate-in fade-in">
