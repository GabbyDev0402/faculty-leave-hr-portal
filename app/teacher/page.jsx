...
export default function TeacherDashboard() {
  ...
  const fetchTeacherData = async (isInitial = true) => {
    ...
    try {
      ...
      if (authError || !authData?.user) {
        console.warn("No active auth user found.");
        setUser(null);
      ...
      if (isInitial) setErrorMsg("Unable to load records. Please try again.");
    } finally {
      if (isInitial) setLoading(false);
    }
  };
  ...
  // Handle File Upload to Storage Bucket ('lesson_plans')
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3">
              ...
              <p className="text-[11px] text-slate-500 flex items-center gap-1">
                ...
                <span>Based on your annual allotment.</span>
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3">
              ...
              <p className="text-[11px] text-slate-500 flex items-center gap-1">
                ...
                <span>Total classes requiring coverage.</span>
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Track the status and coverage of your absence requests.</p>
                </div>
              ...
              {loading ? (
                <div className="py-12 text-center text-slate-400 space-y-3">
                  ...
                  <p className="text-xs font-medium">Loading your leave records...</p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-4">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Upload secure instructional materials for your assigned substitute.
              </p>

              {isUploading ? (
                <div className="border-2 border-dashed border-indigo-200 rounded-xl p-6 text-center bg-indigo-50/40 space-y-2">
                  <Loader2 className="w-8 h-8 text-indigo-600 animate-spin mx-auto" />
                  <p className="text-xs font-semibold text-indigo-900">Uploading instructional document...</p>
                  <p className="text-[10px] text-indigo-500">Securing file for substitute access</p>
                </div>
              ) : uploadedFilePath ? (
              ...
              <div className="pt-2 text-[11px] text-slate-400 flex items-center gap-1.5">
                ...
                <span>Attached to your leave request</span>
              </div>
            </div>
              ...
              <div className="pt-2 border-t border-slate-100 space-y-3">
                <div className="flex items-center justify-between">
                  <label className="block text-xs font-bold text-slate-900 flex items-center gap-1.5">
                    ...
                    <span>Class Coverage Schedules</span>
                  </label>
                  <button
                    type="button"
              ...
              <div className="pt-2 border-t border-slate-100">
                ...
                {isUploading ? (
                  <div className="p-3 bg-indigo-50/60 rounded-xl border border-indigo-100 flex items-center space-x-2 text-xs text-indigo-700">
                    ...
                    <span>Uploading instructional document...</span>
                  </div>
                ) : uploadedFilePath ? (
